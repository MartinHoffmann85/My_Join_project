/**
 * Generates HTML template for the sign-up popup.
 * @returns {string} - HTML template for sign-up popup.
 */
...
/**
 * Generates HTML template for an assigned-to container.
 * @param {string} contact - Contact name.
 * @param {number} index - Index of the assigned-to container.
 ...
 * @returns {string} - HTML template for assigned-to container.
 */
...
/**
 * Generates HTML template for a confirmed checkbox SVG.
 * @returns {string} - HTML template for confirmed checkbox SVG.
 */
...
/**
 * Generates HTML template for a default checkbox SVG.
 * @returns {string} - HTML template for default checkbox SVG.
 */
...
/**
 * Generates HTML template for added contacts.
 * @param {number} index - Index of the contact.
 * @param {string} iconColor - Color of the icon.
 * @param {string} initials - Initials of the contact.
 * @param {string} textColor - Text color.
 * @returns {string} - HTML template for added contacts.
 */
...
/**
 * Generates HTML template for a subtask.
 * @param {number} index - Index of the subtask.
 * @param {string} subtask - Subtask content.
